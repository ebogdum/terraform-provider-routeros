...
func TestAccRoutingOSPFStaticNeighbor(t *testing.T) {
...
resource "routeros_routing_ospf_static_neighbor" "acc" {
  router = "home"
}
`
	...
	_ = "routeros_routing_ospf_static_neighbor" // silence unused
}
