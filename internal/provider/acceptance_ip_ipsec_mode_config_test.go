...
func TestAccIPIpsecModeConfig(t *testing.T) {
...
resource "routeros_ip_ipsec_mode_config" "acc" {
  router = "home"
  name = "tf-example"
}
`
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{Config: cfg, Check: resource.ComposeTestCheckFunc(
				resource.TestCheckResourceAttrSet("routeros_ip_ipsec_mode_config.acc", "id"),
			)},
		},
	})
}
