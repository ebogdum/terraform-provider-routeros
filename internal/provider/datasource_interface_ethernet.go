...
type InterfaceEthernetDataSource struct{ reg *client.Registry }

type InterfaceEthernetDSModel struct {
	Router  types.String `tfsdk:"router"`
	Filter  types.Map    `tfsdk:"filter"`
	Records types.List   `tfsdk:"records"`
}

func NewInterfaceEthernetDataSource() datasource.DataSource { return &InterfaceEthernetDataSource{} }
...
func (d *InterfaceEthernetDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *InterfaceEthernetDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists records from /interface/ethernet.",
...
func (d *InterfaceEthernetDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var m InterfaceEthernetDSModel
	...
	rows, err := c.List(ctx, "/interface/ethernet", opts...)
	if err != nil {
