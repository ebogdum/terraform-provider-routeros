...
type PortDataSource struct{ reg *client.Registry }

type PortDSModel struct {
	Router  types.String `tfsdk:"router"`
	Filter  types.Map    `tfsdk:"filter"`
	Records types.List   `tfsdk:"records"`
}

func NewPortDataSource() datasource.DataSource { return &PortDataSource{} }
...
func (d *PortDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists records from /port.",
