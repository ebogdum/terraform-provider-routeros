...
func TestAccRoutingIgmpProxy(t *testing.T) {
...
resource "routeros_routing_igmp_proxy" "this" {
  router = "home"
}
`
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{Config: cfg, Check: resource.ComposeTestCheckFunc(
				resource.TestCheckResourceAttrSet("routeros_routing_igmp_proxy.this", "id"),
			)},
		},
	})
}
