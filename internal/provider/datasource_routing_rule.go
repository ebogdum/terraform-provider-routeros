...
type RoutingRuleDataSource struct{ reg *client.Registry }

type RoutingRuleDSModel struct {
	Router  types.String `tfsdk:"router"`
	Filter  types.Map    `tfsdk:"filter"`
	Records types.List   `tfsdk:"records"`
}

func NewRoutingRuleDataSource() datasource.DataSource { return &RoutingRuleDataSource{} }
...
func (d *RoutingRuleDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *RoutingRuleDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists records from /routing/rule.",
...
func (d *RoutingRuleDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	rows, err := c.List(ctx, "/routing/rule", opts...)
	if err != nil {
