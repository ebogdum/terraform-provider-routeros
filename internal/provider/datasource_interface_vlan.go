...
type InterfaceVLANDataSource struct{ reg *client.Registry }

type InterfaceVLANDSModel struct {
	Router  types.String `tfsdk:"router"`
	Filter  types.Map    `tfsdk:"filter"`
	Records types.List   `tfsdk:"records"`
}

func NewInterfaceVLANDataSource() datasource.DataSource { return &InterfaceVLANDataSource{} }
...
func (d *InterfaceVLANDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *InterfaceVLANDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists records from /interface/vlan.",
...
func (d *InterfaceVLANDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	rows, err := c.List(ctx, "/interface/vlan", opts...)
	if err != nil {
