...
func TestAccIPFirewallAddressList(t *testing.T) {
...
resource "routeros_ip_firewall_address_list" "acc" {
  router = "home"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{Config: cfg, Check: resource.ComposeTestCheckFunc(
				resource.TestCheckResourceAttrSet("routeros_ip_firewall_address_list.acc", "id"),
			)},
		},
	})
}
