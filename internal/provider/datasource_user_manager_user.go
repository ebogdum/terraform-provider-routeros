...
var (
	_ datasource.DataSource = &UserManagerUserDataSource{}
	_                       = fmt.Sprintf
)

type UserManagerUserDataSource struct{ reg *client.Registry }

type UserManagerUserDSModel struct {
...
func NewUserManagerUserDataSource() datasource.DataSource { return &UserManagerUserDataSource{} }

func (d *UserManagerUserDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_user_manager_user"
}

func (d *UserManagerUserDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *UserManagerUserDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists records from /user-manager/user.",
...
func (d *UserManagerUserDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var m UserManagerUserDSModel
	...
	rows, err := c.List(ctx, "/user-manager/user", opts...)
	if err != nil {
