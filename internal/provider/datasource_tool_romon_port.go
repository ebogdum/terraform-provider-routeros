...
var (
	_ datasource.DataSource = &ToolRomonPortDataSource{}
	_                       = fmt.Sprintf
)

type ToolRomonPortDataSource struct{ reg *client.Registry }

type ToolRomonPortDSModel struct {
...
func NewToolRomonPortDataSource() datasource.DataSource { return &ToolRomonPortDataSource{} }

func (d *ToolRomonPortDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_tool_romon_port"
}

func (d *ToolRomonPortDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ToolRomonPortDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists records from /tool/romon/port.",
...
func (d *ToolRomonPortDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var m ToolRomonPortDSModel
	...
	rows, err := c.List(ctx, "/tool/romon/port", opts...)
	if err != nil {
