...
type RoutingTableDataSource struct{ reg *client.Registry }

type RoutingTableDSModel struct {
	Router  types.String `tfsdk:"router"`
	Filter  types.Map    `tfsdk:"filter"`
	Records types.List   `tfsdk:"records"`
}

func NewRoutingTableDataSource() datasource.DataSource { return &RoutingTableDataSource{} }
...
func (d *RoutingTableDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *RoutingTableDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists records from /routing/table.",
...
func (d *RoutingTableDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	rows, err := c.List(ctx, "/routing/table", opts...)
	if err != nil {
