...
var (
	_ datasource.DataSource = &InterfaceIpipDataSource{}
	_                       = fmt.Sprintf
)

type InterfaceIpipDataSource struct{ reg *client.Registry }

type InterfaceIpipDSModel struct {
...
func NewInterfaceIpipDataSource() datasource.DataSource { return &InterfaceIpipDataSource{} }

func (d *InterfaceIpipDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_interface_ipip"
}

func (d *InterfaceIpipDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *InterfaceIpipDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists records from /interface/ipip.",
...
func (d *InterfaceIpipDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var m InterfaceIpipDSModel
	...
	rows, err := c.List(ctx, "/interface/ipip", opts...)
	if err != nil {
