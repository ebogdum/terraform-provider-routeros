...
var (
	_ datasource.DataSource = &InterfacePPPClientDataSource{}
	_                       = fmt.Sprintf
)

type InterfacePPPClientDataSource struct{ reg *client.Registry }

type InterfacePPPClientDSModel struct {
...
func NewInterfacePPPClientDataSource() datasource.DataSource { return &InterfacePPPClientDataSource{} }

func (d *InterfacePPPClientDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_interface_ppp_client"
}

func (d *InterfacePPPClientDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *InterfacePPPClientDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists records from /interface/ppp-client.",
...
func (d *InterfacePPPClientDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var m InterfacePPPClientDSModel
	...
	rows, err := c.List(ctx, "/interface/ppp-client", opts...)
	if err != nil {
