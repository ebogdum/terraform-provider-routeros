...
var (
	_ datasource.DataSource = &IPHotspotProfileDataSource{}
	_                       = fmt.Sprintf
)

type IPHotspotProfileDataSource struct{ reg *client.Registry }

type IPHotspotProfileDSModel struct {
...
func NewIPHotspotProfileDataSource() datasource.DataSource { return &IPHotspotProfileDataSource{} }

func (d *IPHotspotProfileDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ip_hotspot_profile"
}

func (d *IPHotspotProfileDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *IPHotspotProfileDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists records from /ip/hotspot/profile.",
...
func (d *IPHotspotProfileDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var m IPHotspotProfileDSModel
	...
	rows, err := c.List(ctx, "/ip/hotspot/profile", opts...)
	if err != nil {
