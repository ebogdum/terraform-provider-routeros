...
func TestAccIPV6FirewallFilter(t *testing.T) {
...
resource "routeros_ipv6_firewall_filter" "acc" {
  router = "home"
  action = "accept"
  chain = "forward"
  lockout_ack = true
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{Config: cfg, Check: resource.ComposeTestCheckFunc(
				resource.TestCheckResourceAttrSet("routeros_ipv6_firewall_filter.acc", "id"),
			)},
		},
	})
}
