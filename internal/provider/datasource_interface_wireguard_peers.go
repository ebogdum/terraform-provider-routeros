...
var (
	_ datasource.DataSource = &InterfaceWireguardPeersDataSource{}
	_                       = fmt.Sprintf
)
...
func NewInterfaceWireguardPeersDataSource() datasource.DataSource {
	return &InterfaceWireguardPeersDataSource{}
}

func (d *InterfaceWireguardPeersDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_interface_wireguard_peers"
}

func (d *InterfaceWireguardPeersDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *InterfaceWireguardPeersDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists records from /interface/wireguard/peers.",
...
func (d *InterfaceWireguardPeersDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var m InterfaceWireguardPeersDSModel
