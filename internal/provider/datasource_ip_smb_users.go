...
var (
	_ datasource.DataSource = &IPSmbUsersDataSource{}
	_                       = fmt.Sprintf
)

type IPSmbUsersDataSource struct{ reg *client.Registry }

type IPSmbUsersDSModel struct {
...
func NewIPSmbUsersDataSource() datasource.DataSource { return &IPSmbUsersDataSource{} }

func (d *IPSmbUsersDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ip_smb_users"
}

func (d *IPSmbUsersDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *IPSmbUsersDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists records from /ip/smb/users.",
...
func (d *IPSmbUsersDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var m IPSmbUsersDSModel
	...
	rows, err := c.List(ctx, "/ip/smb/users", opts...)
	if err != nil {
