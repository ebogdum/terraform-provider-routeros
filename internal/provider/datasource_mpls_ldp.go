...
type MPLSLdpDataSource struct{ reg *client.Registry }

type MPLSLdpDSModel struct {
	Router  types.String `tfsdk:"router"`
	Filter  types.Map    `tfsdk:"filter"`
	Records types.List   `tfsdk:"records"`
}

func NewMPLSLdpDataSource() datasource.DataSource { return &MPLSLdpDataSource{} }
...
func (d *MPLSLdpDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *MPLSLdpDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists records from /mpls/ldp.",
...
func (d *MPLSLdpDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	rows, err := c.List(ctx, "/mpls/ldp", opts...)
	if err != nil {
