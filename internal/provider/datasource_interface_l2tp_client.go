...
var (
	_ datasource.DataSource = &InterfaceL2TPClientDataSource{}
	_                       = fmt.Sprintf
)

type InterfaceL2TPClientDataSource struct{ reg *client.Registry }

type InterfaceL2TPClientDSModel struct {
...
func NewInterfaceL2TPClientDataSource() datasource.DataSource {
	return &InterfaceL2TPClientDataSource{}
}

func (d *InterfaceL2TPClientDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_interface_l2tp_client"
}

func (d *InterfaceL2TPClientDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *InterfaceL2TPClientDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists records from /interface/l2tp-client.",
...
func (d *InterfaceL2TPClientDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var m InterfaceL2TPClientDSModel
	...
	rows, err := c.List(ctx, "/interface/l2tp-client", opts...)
	if err != nil {
