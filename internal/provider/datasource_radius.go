...
type RADIUSDataSource struct{ reg *client.Registry }

type RADIUSDSModel struct {
...
func NewRADIUSDataSource() datasource.DataSource { return &RADIUSDataSource{} }
...
func (d *RADIUSDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *RADIUSDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists records from /radius.",
...
func (d *RADIUSDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	rows, err := c.List(ctx, "/radius", opts...)
	if err != nil {
