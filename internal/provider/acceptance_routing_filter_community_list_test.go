...
func TestAccRoutingFilterCommunityList(t *testing.T) {
...
resource "routeros_routing_filter_community_list" "acc" {
  router = "home"
}
`
	...
	_ = "routeros_routing_filter_community_list" // silence unused
}
