...
func TestAccIPV6FirewallMangle(t *testing.T) {
...
resource "routeros_ipv6_firewall_mangle" "acc" {
  router = "home"
  action = "accept"
  chain = "prerouting"
}
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{Config: cfg, Check: resource.ComposeTestCheckFunc(
				resource.TestCheckResourceAttrSet("routeros_ipv6_firewall_mangle.acc", "id"),
			)},
		},
	})
}
