...
func TestAccIPDHCPServerAlert(t *testing.T) {
...
resource "routeros_ip_dhcp_server_alert" "acc" {
  router = "home"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{Config: cfg, Check: resource.ComposeTestCheckFunc(
				resource.TestCheckResourceAttrSet("routeros_ip_dhcp_server_alert.acc", "id"),
			)},
		},
	})
}
