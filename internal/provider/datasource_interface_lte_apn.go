...
var (
	_ datasource.DataSource = &InterfaceLteApnDataSource{}
	_                       = fmt.Sprintf
)

type InterfaceLteApnDataSource struct{ reg *client.Registry }

type InterfaceLteApnDSModel struct {
...
func NewInterfaceLteApnDataSource() datasource.DataSource { return &InterfaceLteApnDataSource{} }

func (d *InterfaceLteApnDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_interface_lte_apn"
}

func (d *InterfaceLteApnDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *InterfaceLteApnDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists records from /interface/lte/apn.",
...
func (d *InterfaceLteApnDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var m InterfaceLteApnDSModel
	...
	rows, err := c.List(ctx, "/interface/lte/apn", opts...)
	if err != nil {
