...
func TestAccInterfaceWireguard(t *testing.T) {
...
resource "routeros_interface_wireguard" "acc" {
  router = "home"
}
`
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{Config: cfg, Check: resource.ComposeTestCheckFunc(
				resource.TestCheckResourceAttrSet("routeros_interface_wireguard.acc", "id"),
			)},
		},
	})
}
