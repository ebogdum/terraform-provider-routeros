...
func TestAccRoutingBGPInstance(t *testing.T) {
...
resource "routeros_routing_bgp_instance" "acc" {
  router = "home"
}
`
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{Config: cfg, Check: resource.ComposeTestCheckFunc(
				resource.TestCheckResourceAttrSet("routeros_routing_bgp_instance.acc", "id"),
			)},
		},
	})
}
