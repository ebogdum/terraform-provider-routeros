...
func TestAccToolTrafficGeneratorPort(t *testing.T) {
...
resource "routeros_tool_traffic_generator_port" "acc" {
  router = "home"
}
`
	...
	_ = "routeros_tool_traffic_generator_port" // silence unused
}
