...
func TestAccIPFirewallLayer7Protocol(t *testing.T) {
...
resource "routeros_ip_firewall_layer7_protocol" "acc" {
  router = "home"
}
`
	...
	_ = "routeros_ip_firewall_layer7_protocol" // silence unused
}
