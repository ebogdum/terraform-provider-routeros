...
func TestAccCapsManRegistrationTable(t *testing.T) {
...
resource "routeros_caps_man_registration_table" "acc" {
  router = "home"
}
`
	...
	_ = "routeros_caps_man_registration_table" // silence unused
}
