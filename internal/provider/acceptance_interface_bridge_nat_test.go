...
func TestAccInterfaceBridgeNAT(t *testing.T) {
...
resource "routeros_interface_bridge_nat" "acc" {
  router = "home"
  chain = "srcnat"
}
`
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{Config: cfg, Check: resource.ComposeTestCheckFunc(
				resource.TestCheckResourceAttrSet("routeros_interface_bridge_nat.acc", "id"),
			)},
		},
	})
}
