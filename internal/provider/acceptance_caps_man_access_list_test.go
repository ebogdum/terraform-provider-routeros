...
func TestAccCapsManAccessList(t *testing.T) {
...
resource "routeros_caps_man_access_list" "acc" {
  router = "home"
}
`
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{Config: cfg, Check: resource.ComposeTestCheckFunc(
				resource.TestCheckResourceAttrSet("routeros_caps_man_access_list.acc", "id"),
			)},
		},
	})
}
