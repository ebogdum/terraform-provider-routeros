...
func TestAccUserManagerProfile(t *testing.T) {
...
resource "routeros_user_manager_profile" "acc" {
  router = "home"
}
`
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{Config: cfg, Check: resource.ComposeTestCheckFunc(
				resource.TestCheckResourceAttrSet("routeros_user_manager_profile.acc", "id"),
			)},
		},
	})
}
