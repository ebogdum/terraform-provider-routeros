...
type PartitionDataSource struct{ reg *client.Registry }

type PartitionDSModel struct {
	Router  types.String `tfsdk:"router"`
	Filter  types.Map    `tfsdk:"filter"`
	Records types.List   `tfsdk:"records"`
}

func NewPartitionDataSource() datasource.DataSource { return &PartitionDataSource{} }
...
func (d *PartitionDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists records from /partition.",
...
func (d *PartitionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	rows, err := c.List(ctx, "/partition", opts...)
	if err != nil {
