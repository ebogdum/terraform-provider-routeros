...
var (
	_ datasource.DataSource = &InterfaceBridgeDataSource{}
	_                       = fmt.Sprintf
)

type InterfaceBridgeDataSource struct{ reg *client.Registry }

type InterfaceBridgeDSModel struct {
	Router  types.String `tfsdk:"router"`
	Filter  types.Map    `tfsdk:"filter"`
	Records types.List   `tfsdk:"records"`
}

func NewInterfaceBridgeDataSource() datasource.DataSource { return &InterfaceBridgeDataSource{} }
...
func (d *InterfaceBridgeDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists records from /interface/bridge.",
...
func (d *InterfaceBridgeDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	rows, err := c.List(ctx, "/interface/bridge", opts...)
	if err != nil {
