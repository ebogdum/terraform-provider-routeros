...
var (
	_ datasource.DataSource = &InterfaceWifiSecurityMultiPassphraseDataSource{}
	_                       = fmt.Sprintf
)
...
func NewInterfaceWifiSecurityMultiPassphraseDataSource() datasource.DataSource {
	return &InterfaceWifiSecurityMultiPassphraseDataSource{}
}

func (d *InterfaceWifiSecurityMultiPassphraseDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_interface_wifi_security_multi_passphrase"
}

func (d *InterfaceWifiSecurityMultiPassphraseDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *InterfaceWifiSecurityMultiPassphraseDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists records from /interface/wifi/security/multi-passphrase.",
...
func (d *InterfaceWifiSecurityMultiPassphraseDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var m InterfaceWifiSecurityMultiPassphraseDSModel
