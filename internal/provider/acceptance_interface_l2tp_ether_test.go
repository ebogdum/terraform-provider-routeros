...
func TestAccInterfaceL2TPEther(t *testing.T) {
...
resource "routeros_interface_l2tp_ether" "acc" {
  router = "home"
}
`
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{Config: cfg, Check: resource.ComposeTestCheckFunc(
				resource.TestCheckResourceAttrSet("routeros_interface_l2tp_ether.acc", "id"),
			)},
		},
	})
}
