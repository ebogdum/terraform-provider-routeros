...
var (
	_ datasource.DataSource = &InterfaceGreDataSource{}
	_                       = fmt.Sprintf
)

type InterfaceGreDataSource struct{ reg *client.Registry }

type InterfaceGreDSModel struct {
...
func NewInterfaceGreDataSource() datasource.DataSource { return &InterfaceGreDataSource{} }

func (d *InterfaceGreDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_interface_gre"
}

func (d *InterfaceGreDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *InterfaceGreDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists records from /interface/gre.",
...
func (d *InterfaceGreDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var m InterfaceGreDSModel
	...
	rows, err := c.List(ctx, "/interface/gre", opts...)
	if err != nil {
