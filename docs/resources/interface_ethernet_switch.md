...
* `l3_hw_offloading` - (Optional) Type: `string`. Enables or disables Layer 3 Hardware Offloading on the switch chip. Not all switch chips support L3 hardware offloading.
