...
* `public_address` - (Optional) Type: `string`. Shows the device's IPv4 address that was sent to the cloud server. This field is visible only after at least one IP Cloud request was successfully completed.
* `public_address_ivp6` - (Optional) Type: `string`. Shows the device's IPv6 address that was sent to the cloud server. This field is visible only after at least one IP Cloud request was successfully completed.
...
* `vpn_peer_private_key` - (Optional) Type: `string`. Peer private key.
...
* `vpn_private_key` - (Optional) Type: `string`. Private key for BTH.
