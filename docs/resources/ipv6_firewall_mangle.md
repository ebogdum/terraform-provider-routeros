...
page_title: "RouterOS: routeros_ipv6_firewall_mangle"
description: |-
  RouterOS resource.
---

# Resource: routeros_ipv6_firewall_mangle

Manages the RouterOS `/ipv6/firewall/mangle` menu.
...
* `dst_prefix` - (Optional) Type: `string`. RouterOS `dst-prefix`.
...
* `new_hop_limit` - (Optional) Type: `string`. RouterOS `new-hop-limit`.
...
* `src_prefix` - (Optional) Type: `string`.
...
```sh
# Default router, .id = *3
terraform import routeros_ipv6_firewall_mangle.example '*3'

# Named router
terraform import routeros_ipv6_firewall_mangle.example 'home/*3'

# By natural key (the resource's `name` attribute, when present)
terraform import routeros_ipv6_firewall_mangle.example 'home/my-resource-name'
```
