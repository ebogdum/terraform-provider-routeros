...
# Resource: routeros_interface_sstp_client
...
```sh
# Default router, .id = *3
terraform import routeros_interface_sstp_client.example '*3'

# Named router
terraform import routeros_interface_sstp_client.example 'home/*3'

# By natural key (the resource's `name` attribute, when present)
terraform import routeros_interface_sstp_client.example 'home/my-resource-name'
```
