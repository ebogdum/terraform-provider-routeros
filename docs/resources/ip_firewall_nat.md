...
```terraform
resource "routeros_ip_firewall_nat" "nat_example" {
...
```sh
# Default router, .id = *3
terraform import routeros_ip_firewall_nat.example '*3'

# Named router
terraform import routeros_ip_firewall_nat.example 'home/*3'

# By natural key (the resource's `name` attribute, when present)
terraform import routeros_ip_firewall_nat.example 'home/my-resource-name'
```
