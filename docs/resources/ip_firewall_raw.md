...
# Resource: routeros_ip_firewall_raw
...
```terraform
resource "routeros_ip_firewall_raw" "raw_example" {
...
```sh
# Default router, .id = *3
terraform import routeros_ip_firewall_raw.example '*3'

# Named router
terraform import routeros_ip_firewall_raw.example 'home/*3'

# By natural key (the resource's `name` attribute, when present)
terraform import routeros_ip_firewall_raw.example 'home/my-resource-name'
```
