...
# Data Source: routeros_ipv6_firewall_connection

Manages the RouterOS `/ipv6/firewall/connection` menu.

## Example Usage

```terraform
data "routeros_ipv6_firewall_connection" "connection_example" {
...
* `dst_address` - (Optional) Type: `ipv6`.
...
* `reply_dst_address` - (Optional) Type: `ipv6`.
* `reply_dst_port` - (Optional) Type: `int`.
* `reply_src_address` - (Optional) Type: `ipv6`.
* `reply_src_port` - (Optional) Type: `int`.
* `seen_reply` - (Optional) Type: `bool`.
* `src_address` - (Optional) Type: `ipv6`.
